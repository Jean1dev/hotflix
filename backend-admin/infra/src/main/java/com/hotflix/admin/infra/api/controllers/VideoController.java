...
import com.hotflix.admin.application.video.create.CreateVideoCommand;
import com.hotflix.admin.application.video.create.CreateVideoUseCase;
import com.hotflix.admin.application.video.delete.DeleteVideoUseCase;
import com.hotflix.admin.application.video.media.get.GetMediaCommand;
import com.hotflix.admin.application.video.media.get.GetMediaUseCase;
import com.hotflix.admin.application.video.media.upload.UploadMediaCommand;
import com.hotflix.admin.application.video.media.upload.UploadMediaUseCase;
import com.hotflix.admin.application.video.retrieve.get.GetVideoByIdUseCase;
import com.hotflix.admin.application.video.retrieve.list.ListVideosUseCase;
import com.hotflix.admin.application.video.update.UpdateVideoCommand;
import com.hotflix.admin.application.video.update.UpdateVideoUseCase;
...
import com.hotflix.admin.infra.api.VideoAPI;
import com.hotflix.admin.infra.utils.HashingUtils;
import com.hotflix.admin.infra.video.models.CreateVideoRequest;
import com.hotflix.admin.infra.video.models.UpdateVideoRequest;
import com.hotflix.admin.infra.video.models.VideoListResponse;
import com.hotflix.admin.infra.video.models.VideoResponse;
import com.hotflix.admin.infra.video.presenters.VideoApiPresenter;
...
public class VideoController implements VideoAPI {
    ...
    public ResponseEntity<?> uploadMediaByType(final String id, final String type, final MultipartFile media) {
        final var aType = VideoMediaType.of(type)
                .orElseThrow(() -> NotificationException.with(new DomainError("Invalid %s for VideoMediaType".formatted(type))));
