...
import com.hotflix.admin.application.video.create.DefaultCreateVideoUseCase;
import com.hotflix.admin.application.video.delete.DefaultDeleteVideoUseCase;
import com.hotflix.admin.application.video.delete.DeleteVideoUseCase;
import com.hotflix.admin.application.video.media.get.DefaultGetMediaUseCase;
import com.hotflix.admin.application.video.media.get.GetMediaUseCase;
import com.hotflix.admin.application.video.media.update.DefaultUpdateMediaStatusUseCase;
import com.hotflix.admin.application.video.media.update.UpdateMediaStatusUseCase;
import com.hotflix.admin.application.video.media.upload.DefaultUploadMediaUseCase;
import com.hotflix.admin.application.video.media.upload.UploadMediaUseCase;
import com.hotflix.admin.application.video.retrieve.get.DefaultGetVideoByIdUseCase;
import com.hotflix.admin.application.video.retrieve.get.GetVideoByIdUseCase;
import com.hotflix.admin.application.video.retrieve.list.DefaultListVideosUseCase;
import com.hotflix.admin.application.video.retrieve.list.ListVideosUseCase;
import com.hotflix.admin.application.video.update.DefaultUpdateVideoUseCase;
