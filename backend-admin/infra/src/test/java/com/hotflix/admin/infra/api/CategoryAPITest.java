...
public class CategoryAPITest {
    ...
    @MockBean
    private UpdateCategoryService updateCategoryUseCase;
    ...
    public void givenAInvalidName_whenCallsCreateCategory_thenShouldReturnNotification() throws Exception {
        ...
        when(createCategoryUseCase.execute(any()))
                .thenReturn(Left(NotificationHandler.create(new Error(expectedMessage))));
    ...
    public void givenAInvalidCommand_whenCallsCreateCategory_thenShouldReturnDomainException() throws Exception {
        ...
        when(createCategoryUseCase.execute(any()))
                .thenThrow(DomainException.with(new DomainError(expectedMessage)));
    ...
    public void givenValidParams_whenCallsListCategories_shouldReturnCategories() throws Exception {
        ...
        response.andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$.itens[0].created_at", equalTo(aCategory.getCreatedAt().toString())))
