...
public class DefaultVideoGatewayTest {
    ...
    public void givenEmptyParams_whenCallFindAll_shouldReturnAllList() {
        ...
        Assertions.assertEquals(expectedTotal, actualPage.itens().size());
    }
    ...
    public void givenAValidCategory_whenCallFindAll_shouldReturnFilteredList() {
        ...
        Assertions.assertEquals("21.1 Implementação dos testes integrados do findAll", actualPage.itens().get(0).title());
        Assertions.assertEquals("Aula de empreendedorismo", actualPage.itens().get(1).title());
    }
    ...
    public void givenAValidCastMember_whenCallFindAll_shouldReturnFilteredList() {
        ...
        Assertions.assertEquals("Aula de empreendedorismo", actualPage.itens().get(0).title());
        Assertions.assertEquals("System Design no Mercado Livre na prática", actualPage.itens().get(1).title());
    }
    ...
    public void givenAValidPaging_whenCallsFindAll_shouldReturnPaged(
        ...
        Assertions.assertEquals(expectedPerPage, actualPage.perPage());
        Assertions.assertEquals(expectedTotal, actualPage.total());
        Assertions.assertEquals(expectedItemsCount, actualPage.itens().size());

        int index = 0;
        for (final var expectedTitle : expectedVideos.split(";")) {
            final var actualTitle = actualPage.itens().get(index).title();
    ...
    public void givenAValidTerm_whenCallsFindAll_shouldReturnFiltered(
        ...
        Assertions.assertEquals(expectedTotal, actualPage.total());
        Assertions.assertEquals(expectedItemsCount, actualPage.itens().size());
        Assertions.assertEquals(expectedVideo, actualPage.itens().get(0).title());
    }
