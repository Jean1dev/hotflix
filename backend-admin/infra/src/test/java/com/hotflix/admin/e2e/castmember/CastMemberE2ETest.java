...
public class CastMemberE2ETest implements MockDsl {
    ...
    public void asACatalogAdminIShouldBeAbleToNavigateThruAllMembers() throws Exception {
        ...
        listCastMembers(0, 1)
                ...
                .andExpect(jsonPath("$.itens[0].name", equalTo("Jason Momoa")));
        ...
        listCastMembers(1, 1)
                ...
                .andExpect(jsonPath("$.total", equalTo(3)))
                .andExpect(jsonPath("$.itens", hasSize(1)))
                .andExpect(jsonPath("$.itens[0].name", equalTo("Quentin Tarantino")));
        ...
        listCastMembers(2, 1)
                ...
                .andExpect(jsonPath("$.total", equalTo(3)))
                .andExpect(jsonPath("$.itens", hasSize(1)))
                .andExpect(jsonPath("$.itens[0].name", equalTo("Vin Diesel")));
    ...
    public void asACatalogAdminIShouldBeAbleToSortAllMembersByNameDesc() throws Exception {
        ...
        listCastMembers(0, 3, "", "name", "desc")
                ...
                .andExpect(jsonPath("$.itens[0].name", equalTo("Vin Diesel")))
                .andExpect(jsonPath("$.itens[1].name", equalTo("Quentin Tarantino")))
                .andExpect(jsonPath("$.itens[2].name", equalTo("Jason Momoa")));
    }
