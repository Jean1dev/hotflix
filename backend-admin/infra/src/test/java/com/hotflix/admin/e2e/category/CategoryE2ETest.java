package com.hotflix.admin.e2e.category;
...
public class CategoryE2ETest implements MockDsl {
    ...
    public void asACatalogAdminIShouldBeAbleToNavigateToAllCategories() throws Exception {
        ...
        listCategories(0, 1)
                ...
                .andExpect(jsonPath("$.itens[0].name", equalTo("Documentários")));
        ...
        listCategories(1, 1)
                ...
                .andExpect(jsonPath("$.total", equalTo(3)))
                .andExpect(jsonPath("$.itens", hasSize(1)))
                .andExpect(jsonPath("$.itens[0].name", equalTo("Filmes")));
        ...
        listCategories(2, 1)
                ...
                .andExpect(jsonPath("$.total", equalTo(3)))
                .andExpect(jsonPath("$.itens", hasSize(1)))
                .andExpect(jsonPath("$.itens[0].name", equalTo("Séries")));
    ...
    public void asACatalogAdminIShouldBeAbleToSortAllCategoriesByDescriptionDesc() throws Exception {
        ...
        listCategories(0, 3, "", "description", "desc")
                ...
                .andExpect(jsonPath("$.itens[0].name", equalTo("Documentários")))
                .andExpect(jsonPath("$.itens[1].name", equalTo("Filmes")))
                .andExpect(jsonPath("$.itens[2].name", equalTo("Séries")));
    }
